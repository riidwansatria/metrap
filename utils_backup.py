...
def calculate_line_distance(gps_gdf, lines_gdf, line_id, utm_crs="EPSG:32736", plot=True):
    """
...
def get_routes_for_line(line_id, gtfs_dir="./data/gtfs", line_id_file="./data/line_id.csv"):
    ...
    # --- Explode route_ids and filter ---
    line_routes = line_id_ref.explode("route_ids")[["line_id", "route_ids"]]
